...
public class LeftSideRedCommand extends SequentialCommandGroup{

    Trajectory trajectory1, trajectory2, trajectory3;

    public LeftSideRedCommand(CANDrivetrain m_drivetrain, CANLauncher m_launcher){
        ...
        Pose2d ShootPoint = new Pose2d(-.09, -.03, Rotation2d.fromDegrees(5));

        var interiorWaypoints1 = new ArrayList<Translation2d>();
        interiorWaypoints1.add(new Translation2d(-.045, 0.015)); //do interior points last

        //trajectory 2
        Pose2d turningPoint = new Pose2d(-2.29,-1.27, Rotation2d.fromDegrees(75));
        ...
        interiorWaypoints3.add(new Translation2d(-2.5,.3));
        interiorWaypoints3.add(new Translation2d(-4.5,3));
        
        Pose2d endPoint = new Pose2d(-5.975,5.049, Rotation2d.fromDegrees(110));
        ...
        trajectory3 = TrajectoryGenerator.generateTrajectory(turningPoint, interiorWaypoints3, endPoint, config);
